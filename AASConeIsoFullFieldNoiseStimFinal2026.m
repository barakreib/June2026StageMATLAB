...
%
% Inputs (all optional):
%   flickerHz   - stimulus flicker frequency in Hz   (default: 4)
...
% precomputed lookup tables - no local subfunctions.
    ...
    for f = 1:stimFrames
        % Full field: square-wave flicker (S-cone iso: red <-> green)
    ...
    record = struct( ...
        'stimulus',        'AASConeIsoFullFieldNoiseStimFinal2026', ...
        'stim_type',       'sq_wave', ...
        'cone_isolation',  'S', ...
    ...
    fprintf('[AASConeIsoFullFieldNoiseStimFinal2026] Logged trial -> %s\n', manifestPath);
